/** Input sanitization and data redaction functions for STOAT logger */

import type { RedactedData, SanitizedInput } from '../types/brands.ts'
import type { SecurityConfig } from '../config/schema.ts'
import { createErrorContext, DataRedactionError, InputSanitizationError, SecurityError } from '../types/errors.ts'
...
/* Patterns for detecting log injection attacks */
