...
import type { LogLevel, OperationId, RequestId, TraceId } from './brands.ts'

// Base error interface with structured metadata
...
// Base STOAT error class with structured context
